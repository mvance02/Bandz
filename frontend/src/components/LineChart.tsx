...
export default function LineChart({ data, showLegend = true }: LineChartProps) {
  return (
      ...
      <ResponsiveContainer width="100%" height={250}>
        <RechartsLineChart data={data}>
          ...
          <Line
            ...
            stroke="#a7f3d0"
            strokeWidth={2.5}
            dot={{ fill: '#a7f3d0', strokeWidth: 0, r: 5 }}
            activeDot={{ r: 7, fill: '#a7f3d0' }}
          />
          <Line
            type="monotone"
            dataKey="noon"
            stroke="#4ade80"
            strokeWidth={2.5}
            dot={{ fill: '#4ade80', strokeWidth: 0, r: 5 }}
